...
export type MutationResolvers<ContextType = any, ParentType extends ResolversParentTypes['Mutation'] = ResolversParentTypes['Mutation']> = {
  createProfile?: Resolver<ResolversTypes['Profile'], ParentType, ContextType, RequireFields<MutationCreateProfileArgs, 'firstName' | 'lastName' | 'userId'>>;
  createRole?: Resolver<ResolversTypes['Role'], ParentType, ContextType, RequireFields<MutationCreateRoleArgs, 'description' | 'name'>>;
  ...
  signUp?: Resolver<ResolversTypes['AuthPayload'], ParentType, ContextType, RequireFields<MutationSignUpArgs, 'email' | 'password' | 'roleId' | 'username'>>;
  updateProfile?: Resolver<ResolversTypes['Profile'], ParentType, ContextType, RequireFields<MutationUpdateProfileArgs, 'id'>>;
...
export type SignInMutation = { __typename?: 'Mutation', signIn: { __typename?: 'AuthPayload', token: string, user: { __typename?: 'User', id: string, email: string, role: { __typename?: 'Role', name: string } } } };
...
export const GetRolesDocument = gql`
  ...
  roles {
    ...
    `;
export type GetRolesComponentProps = Omit<ApolloReactComponents.QueryComponentOptions<GetRolesQuery, GetRolesQueryVariables>, 'query'>;

    export const GetRolesComponent = (props: GetRolesComponentProps) => (
      <ApolloReactComponents.Query<GetRolesQuery, GetRolesQueryVariables> query={GetRolesDocument} {...props} />
    );
